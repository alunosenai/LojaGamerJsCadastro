...
function gerar_json() {
    ...
    console.log(json);
    document.write("<h1>Confira os seus dados</h1><br><h2>Teste</h2>");
    document.write(json);
    document.write("<h4> Nome: </h4>" + el_name.value)
    document.write("<h4> CPF: </h4>" + el_cpf.value)
    document.write("<h4> Cel.: </h4>" + el_telefone_cel.value)
    document.write("<h4> Res.: </h4>" + el_telefone_res.value)
    document.write("<h4> Cep: </h4>" + el_cep.value)
    document.write("<h4> Endereco: </h4>" + el_endereco.value)
    document.write("<h4> Numero: </h4>" + el_numero.value)
    document.write("<h4> Bairro: </h4>" + el_bairro.value)
    document.write("<h4> Cidade: </h4>" + el_cidade.value)
    document.write("<h4> Estado: </h4>" + el_estado.value)
